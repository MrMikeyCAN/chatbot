...
# TODO Tüm hepsini birleştirdim (Burada birleştirmesi keyifli ama matematiği...)
...
class SentenceEmbedding(nn.Module):
    "Verilen cümleler için biraz boşluk ekliyoruz her duruma karşı"
...
class PositionwiseFeedForward(nn.Module):
    "Önceki modelin çalışmamasının ana sebebi bu tarz bir gelişmiş forward yerine basit bir forward kullanmammış"
...
class Transformer(nn.Module):
    def __init__(
        ...
        self.linear = nn.Linear(d_model, target_lang_vocab_size)
        self.device = (
